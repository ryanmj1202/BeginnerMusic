...
export const PLAYBACK_SCHEDULER_MS = 25
export const PLAYBACK_LOOKAHEAD_BEATS = 1.2
export const PLAYBACK_LOOKAHEAD_SECONDS = 0.18
...
export const NOTE_DRAG_SCROLL_MAX_STEP_PX = 3
export const NOTE_DRAG_SCROLL_SENSITIVITY_PX = 240
